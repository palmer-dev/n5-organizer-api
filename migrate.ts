...
import appointmentSeeder from "./seeder/appointmentSeeder";
import userSeeder from "./seeder/userSeeder";
import agendaSeeder from "./seeder/agendaSeeder";
import workSchedulesSeeder from "./seeder/workSchedulesSeeder";
